...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("University Collage London");
    init();
...
void awan()
{
    glColor3f(240 / 255.0f, 240 / 255.0f, 255 / 255.0f);
    glBegin(GL_POLYGON);
    glVertex2i(320, 515);
    glVertex2i(335, 530);
    glVertex2i(350, 530);
    glVertex2i(365, 515);
    glColor3f(250 / 255.0f, 250 / 255.0f, 255 / 255.0f);
    glVertex2i(365, 500);
    glVertex2i(350, 485);
    glVertex2i(335, 485);
    glVertex2i(320, 500);
...
{
    glPushMatrix();
    glColor3f(251 / 255.0f, 166 / 255.0f, 32 / 255.0f);
    glTranslatef(0, 800, -800);
...
void jendela()
{
    ...
    glVertex3f(5.0, 50.0, 30.1);
    glVertex3f(5.0, -10.0, 30.1);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0.0f, 0.0f, 0.0f);
    glVertex3f(-10.0, 20.0, 30.1);
    glVertex3f(20.0, 20.0, 30.1);
    glEnd();
}
void jendela1()
{
...
void pintu()
{
    ...
    glVertex3f(-20.0, 140.0, 30.0);
    glVertex3f(70.0, 140.0, 30.0);
...
void karpet()
{
    glBegin(GL_QUADS);
    glColor3ub(255, 0, 0);
    glVertex3f(-50.0, 141.0, -230);
    glVertex3f(-50.0, 141.0, -90.0);
    glVertex3f(50.0, 141.0, -90.0);
    glVertex3f(50.0, 141, -230.0);
    glEnd();

}
void bangunansamping()
{
    glPushMatrix();
    glColor3ub(200, 200, 200);
    glTranslatef(280, 130, -310);
    balok(800, 180, 310);
    glPopMatrix();
...
void pagar()
{
    glPushMatrix();//pagar kiri depan
    glColor3ub(160, 82, 45);
    glTranslatef(-580, 35, 350);
    balok(600, 10, 10);
    glTranslatef(0, -4, 0);
    balok(1, 1, 1);
    glPopMatrix();
    ...
    tiang_pagar(); glTranslatef(-200, 0, 0);
    tiang_pagar(); glTranslatef(-200, 0, 0);
    tiang_pagar();
    glPopMatrix();
    glEnd();

    glPushMatrix();//pagar kanan depan
    glColor3ub(160, 82, 45);
    glTranslatef(580, 35, 350);
    balok(600, 10, 10);
    glTranslatef(0, -4, 0);
    ...
    tiang_pagar(); glTranslatef(0, 0, -200);
    tiang_pagar(); glTranslatef(0, 0, -200);
    tiang_pagar(); glTranslatef(0, 0, -200);
    tiang_pagar(); glTranslatef(0, 0, -200);
    tiang_pagar(); glTranslatef(0, 0, -200);
